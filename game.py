...
def display_score():
    ...
    score_surf = test_font.render(f'Score: {calculated}', False, (64, 64, 64))
...
title_text = test_font.render('Pixel Runner', False, (111, 196, 169))
title_rect = title_text.get_rect(center = (400, player_stand_rect.top - 40))

instruction_text = test_font.render('Press Space to begin!', False, (111, 196, 169))
instruction_rect = instruction_text.get_rect(center = (400, player_stand_rect.bottom + 50))
